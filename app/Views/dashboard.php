...
<div class="app">
  <aside class="sidebar">
    ...
    <a href="<?= base_url('bulletin/create') ?>" class="nav-item">
    ...
    <div class="sidebar-bottom">
      <a href="<?= base_url('/') ?>" class="user-row">
  ...
  <div class="main">
    ...
    <div class="content">
      <?php $totalEleves = is_array($eleves ?? null) ? count($eleves) : 0; ?>
      ...
      <div class="page-header">
        ...
        <div class="badge badge-blue"><?= $totalEleves ?> étudiant(s)</div>
      </div>
      ...
      <div class="toolbar">
        <div class="toolbar-left">
          ...
          <a href="<?= base_url('eleves') ?>" class="btn btn-secondary btn-sm">Voir la page complète</a>
        </div>
      </div>
            ...
            <?php if (! empty($eleves)): ?>
              <?php foreach ($eleves as $e): ?>
                <tr>
                  ...
                  <td><?= esc($e['classe']) ?></td>
                  <td>
                    <a href="<?= base_url('bulletin/' . $e['id']) ?>" class="btn btn-primary btn-sm">
                      Voir notes
                    </a>
                  </td>
                </tr>
